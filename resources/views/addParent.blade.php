                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>ID No</label>
                                    <input type="text" placeholder class="form-control" name = "id_parent">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Blood Group *</label>
                                    <select class="select2" name = "blood_grp">
                                ...
                                <div class="col-lg-6 col-12 form-group mg-t-30">
                                    ...
                                    <input type="file" enctype= "multipart/form-data" class="form-control-file" name = "picture">
                                </div>
